...
namespace MVCLaboratorio.Models
{
    public class RepositorioCurso_Tema : ICurso_Tema
    {
        ...
        {
            DataTable dtCurso_Tema = BaseHelper.ejecutarConsulta("sp_CT_ConsultarTodo", CommandType.StoredProcedure);

            List<Curso_Tema> lsCurso_Tema = new List<Curso_Tema>();
            ...
            foreach (DataRow item in dtCurso_Tema.Rows)
            {
                ...
                lsCurso_Tema.Add(datosCurso_Tema);
            }
            return lsCurso_Tema;
        }
        ...
        public Curso_Tema obtenerCurso_Tema(int IdCT)
        {
            ...
            DataTable dtCurso_Tema = BaseHelper.ejecutarConsulta("sp_CT_ConsultarPorID", CommandType.StoredProcedure, parametros);
        ...
        public void eliminarCurso_Tema(int IdCt)
        {
            ...
            BaseHelper.ejecutarConsulta("sp_CT_Eliminar", CommandType.StoredProcedure, parametros);
        }
